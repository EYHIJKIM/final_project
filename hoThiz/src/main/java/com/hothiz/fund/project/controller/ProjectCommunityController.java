...
public class ProjectCommunityController {
   ...
   //스토리에 들어가는 이미지 저장 위치
   private final String IMAGE_REPO = "C:\\javawork\\spring_workspace\\.metadata\\.plugins\\org.eclipse.wst.server.core\\tmp0\\wtpwebapps\\hoThiz\\resources\\img\\community";
