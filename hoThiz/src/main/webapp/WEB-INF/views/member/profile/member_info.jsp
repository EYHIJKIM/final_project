    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-6">
          ...
          <c:otherwise>
            <img class="img-fluid rounded-circle" src="${contextPath }/resources/img/${list.member_email}/${list.member_profile_pic}" alt=""> 
          </c:otherwise>
          </c:choose>
          </div>
        </div>
        <div class="col-lg-6">
          <div class="p-5">
            <h2 class="display-4">${list.member_name }</h2>
            <p>${list.member_introduce }</p>
          </div>
        </div>
      </div>
    </div>
