...
<c:forEach items="${my_donate}" var="dto" varStatus="status">
      <div class="col-lg-3 col-md-6 mb-4">
        <div class="card h-100">
          <img class="card-img-top" id="my_donate_project" src="<%=request.getContextPath()%>/resources/profileImage/${dto.project_main_image}" style="height: 240px;">
          <div class="card-body">
            <h4 class="card-title"><a href="#" style="color: black;">${dto.project_title }</a></font></h4>
            <p class="card-text">
               <div><a href="#" style="size: 2; color: grey;">${dto.project_sub_category }</a>&nbsp;|&nbsp;<a href="#" style="size: 2; color: grey;">${dto.member_name }</a></div>
               <div><font size="3" color="#FF3636">${dto.project_current_percent }%</font>&nbsp;|&nbsp;${donate_price[status.index].member_donate_price }</div>
            </p>
          </div>
          <div class="card-footer">
            <a href="#" class="btn btn-primary">프로젝트 보러가기</a>
          </div>
        </div>
      </div>
</c:forEach>
