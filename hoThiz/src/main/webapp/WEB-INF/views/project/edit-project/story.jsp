...
<div id="video_content">
	...
	<img src="<%=request.getContextPath() %>/resources/project_image/guide/공유버튼.png"><br>
	업로드 하실 유튜브 동영상에서 공유 버튼을 눌러주세요<br>
	<img width="400" height="280" src="<%=request.getContextPath() %>/resources/project_image/guide/퍼가기버튼.png"><br>
	나타난 창에서 퍼가기 버튼을 눌러주세요<br>
	<img width="300" height="350" src="<%=request.getContextPath() %>/resources/project_image/guide/퍼가기.png"><br>
