...
<c:choose>
	...
	<c:if test="${prj.project_prelaunching_check eq '1' and dDayMap[prj.project_id].chk <'0'}" >
	...
	<c:if test="${dDayMap[prj.project_id].d_day <'0'}">
			...
			$.ajax({
				...
				success : function(data) {
					...
					$.each(data["prj"], function(index, proj) { //i배열이 들어온다.
						...
						} if(state=='prelaunching'|| state=='none'){
